class Combinations():
    ...
    def TotalBinomial(self, FirstValue, SecondValue):
        return self.Factorial(max(FirstValue, SecondValue))/(self.Factorial(max(FirstValue, SecondValue)-min(FirstValue, SecondValue))*self.Factorial(min(FirstValue, SecondValue)))
