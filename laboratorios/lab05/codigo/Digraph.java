...
public abstract class Digraph {
     ...
     */
    public abstract void addArc(Node source, Node destination, Double time);
     ...
     */
    public abstract ArrayList<Node> getSuccessors(Node vertex);
     ...
     */  
    public abstract Double getTime(Node source, Node destination);
